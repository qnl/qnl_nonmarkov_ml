...
class MultiTimeStep():
    ...
    def plot_history(self, history):
        ...
        if self.savepath is not None:
            fig.savefig(os.path.join(self.savepath, "training_history_loss_absolute.png"), dpi=200)
        ...
        if self.savepath is not None:
            fig.savefig(os.path.join(self.savepath, "training_history_loss_relative.png"), dpi=200)
        ...
        if self.savepath is not None:
            fig.savefig(os.path.join(self.savepath, "training_history_accuracy.png"), dpi=200)
...
def make_a_pie(time_series_lengths, title="", savepath=None):
    ...
    if savepath is not None:
        fig.savefig(os.path.join(savepath, title.replace(" ", "_") + ".png"),
